...
def test_interpolate(with_manual=False):
    ...
    test_cases = [
        ...
        },
        {
            ...
            {
                "timestamp": [
                    "2023-01-01 00:00:00", "2023-01-01 07:00:00", "2023-01-02 00:00:00", "2023-01-03 00:00:00",
                    "2023-01-04 00:00:00",
                    "2023-01-01 00:00:00", "2023-01-02 00:00:00", "2023-01-03 00:00:00"
                ],
                "patient_id": ['1', '1', '1', '1', '1', '2', '2', '2'],
                "score": [10, 20, 20, 20, 30, 15, 15, 25],
                "is_original": [True, True, False, False, True, True, False, True]
            }
            ),
        },
        {
        ...
        },
        {
            ...
            "data": {
                "patient_id": ['1', '1', '1', '2', '2'],
                "timestamp": [
                    "2023-01-01 00:00:00", "2023-01-08 00:00:00", "2023-01-27 00:00:00",
            ...
            {
                "timestamp": [
                    "2023-01-01 00:00:00", "2023-01-08 00:00:00", "2023-01-15 00:00:00", "2023-01-22 00:00:00",
                    "2023-01-27 00:00:00",
                    "2023-01-29 00:00:00",
                    "2023-01-01 00:00:00", "2023-01-08 00:00:00", "2023-01-15 00:00:00"
                ],
                "patient_id": ['1', '1', '1', '1', '1', '1', '2', '2', '2'],
                "score": [10, 20, 20, 20, 30, 30, 15, 15, 25],
                "is_original": [True, True, False, False, True, False, True, False, True]
            }
            ),
        }
    ]
